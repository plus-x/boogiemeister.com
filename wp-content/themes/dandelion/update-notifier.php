...
define( 'NOTIFIER_THEME_SHORTNAME', 'dandelion' ); // The theme name
define( 'NOTIFIER_XML_FILE', 'http://pexeto.com/updates/dandelion.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
function update_notifier() {
    ...
    2. Make sure that the name of the folder that contains the theme files is called "dandelion". This is the default folder name, so if you haven't modified it manually, the name of the folder on your server should be called "dandelion"</p>
