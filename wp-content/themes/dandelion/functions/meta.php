...
"name" => "slider",
"type" => "select",
"options" => array('Tumbnail Slider', 'Nivo Slider/Fader','Accordion Slider', 'Content Slider', 'Static Header Image', 'None'),
"values" => array('slider-thumbnail', 'slider-nivo','slider-accordion', 'slider-content', 'static-header', 'none'),
"classes" => array('thumbnailslider', 'nivoslider', 'accordionslider', 'contentslider', 'static', 'none'),
"std" => 'none',
"description" => 'If one of the 4 sliders has been selected, you can add the images in the "Dandelion Options" page in
...
"type" => "text",
"title" => "Subtitle",
"description" => "This is the subtitle that will be shown in the horizontal bar below the main menu"),
