...
var pexetoButtons=[
		{
			...
			generateHtml:function(title){
				return '<div id="site-intro"><div id="site-intro-container"><span class="intro-swril swril-left">&nbsp;</span><span class="intro-text">'+title+'</span><span class="intro-swril swril-right">&nbsp;</span></div></div>&nbsp;';
			}
		},
		{
			id:'pexetohighlight1',
		...
		},
		{
			...
			title:'Button',
			allowSelection:false,
			fields:[{id:'text', name:'Text'},{id:'href', name:'Link URL'},{id:'style', name:'Style', values:['dark', 'light']}],
			generateHtml:function(obj){
				var buttonClass=obj.style==='dark'?'button':'button-small';
