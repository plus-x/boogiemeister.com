...
array(
"type" => "open",
"subtitles"=>array(array("id"=>"thumbnail", "name"=>"Thumbnail Slider"), array("id"=>"accordion", "name"=>"Accordion Slider"), array("id"=>"nivo", "name"=>"Nivo Slider"), array("id"=>"content_slider", "name"=>"Content Slider"))
),
...
array(
"name" => "Automatic image resizing",
"id" => $shortname."_accord_auto_resize",
"type" => "checkbox",
"std" => 'off',
...
array(
"name" => "Automatic image resizing",
"id" => $shortname."_nivo_auto_resize",
"type" => "checkbox",
"std" => 'off',
"desc" => 'If enabled, the images will be resized automatically.'
),
...
"type" => "select",
"options" => array(array('id'=>'none','name'=>'None'), array('id'=>'buttons','name'=>'Buttons'), array('id'=>'arrows','name'=>'Arrows'), array('id'=>'butarr','name'=>'Buttons and Arrows')),
"std" => 'none'
),
...
array(
"name" => "Automatic image resizing",
"id" => $shortname."_content_auto_resize",
"type" => "checkbox",
"std" => 'off',
"desc" => 'If enabled, the images will be resized automatically.'
),
...
array(
"name" => "Navigation",
"id" => $shortname."_content_navigation",
"type" => "select",
"options" => array(array('id'=>'none','name'=>'None'), array('id'=>'buttons','name'=>'Buttons'), array('id'=>'arrows','name'=>'Arrows'), array('id'=>'butarr','name'=>'Buttons and Arrows')),
"std" => 'butarr'
),
...
array(
"name" => "Autoplay",
"id" => $shortname."_content_autoplay",
"type" => "checkbox",
"std" => 'on',
"desc" => 'If ON selected, the images will rotate automatically'
),
...
array(
"name" => "Animation Effect",
"id" => $shortname."_content_animation",
"type" => "select",
"options" => array(
array('id'=>'','name'=>'None'),
...
array(
"name" => "Rotate Interval",
"id" => $shortname."_content_interval",
"type" => "text",
"desc" => "The interval between changing the images when autoplay is enabled (in miliseconds)",
"std" => '4000'
),
...
array(
"name" => "Pause on hover",
"id" => $shortname."_content_pause_hover",
"type" => "checkbox",
"std" => 'on',
"desc" => 'If ON selected, when the user hovers the image, the automatic rotation will pause.'
),
...
$pexeto_options_manager->add_options($new_pexeto_slider_options);